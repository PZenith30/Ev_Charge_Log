...
/**
 * ตั้งธีมและสถานะแถบข้างก่อนเบราว์เซอร์วาดหน้าแรก
 * เพื่อไม่ให้เห็นจอขาววาบตอนใช้ Dark mode และไม่เห็นแถบข้างกางแล้วหุบวาบ
...
if(localStorage.getItem('evlog.sidebarCollapsed')==='1')
