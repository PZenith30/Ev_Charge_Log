...
export const DASH_UNITS = {
  'km/kWh': { label: 'km/kWh', toBase: (v) => v, fromBase: (v) => v, step: '0.01', placeholder: '5.20' },
  'km/100kWh': { label: 'km/100kWh', toBase: (v) => v / 100, fromBase: (v) => v * 100, step: '1', placeholder: '520' },
};
