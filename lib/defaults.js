...
export const DEFAULT_SETTINGS = {
  ...
  priceAC: 4.5,
  priceDC: 7.5,
  budget: 0,              // งบรวมต่อเดือน (0 = ไม่ตั้ง)
  budgets: {},            // งบแยกตามชนิด { charge, accessory, insurance, maintenance, tax }
...
// คีย์ทั้งสามยังขึ้นต้นด้วย evlog. ตามเดิม แม้แอปจะเปลี่ยนชื่อเป็น KiloEV แล้ว
// เพราะเป็นคีย์ที่เก็บอยู่ในเครื่องผู้ใช้จริง ถ้าเปลี่ยนชื่อคีย์ ค่าที่ตั้งไว้จะหายทันที
