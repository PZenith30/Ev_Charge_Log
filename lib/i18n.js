...
const EN = {
  ...
  'ตั้งชื่อผู้ใช้': 'Set display name',
  'ชื่อผู้ใช้': 'Display name',
  'ชื่อที่ให้แสดง': 'Name to display',
  'เว้นว่างไว้ก็ได้ ระบบจะใช้ชื่อหน้า @ ของอีเมลแทน': 'Leave it blank to use the part of your email before the @',
  'เช่น สมชาย': 'e.g. Alex',
  'บันทึกชื่อ': 'Save name',
  'กำลังบันทึก…': 'Saving…',
  'บันทึกชื่อผู้ใช้แล้ว': 'Display name saved',
  'ล้างชื่อผู้ใช้แล้ว': 'Display name cleared',
  'ยังไม่ได้ตั้ง ใช้ชื่อจากอีเมลไปก่อน': 'not set — using the name from your email',
  'ผู้ใช้': 'User',
  'ชื่อนี้เก็บอยู่กับบัญชีของคุณ จึงเห็นเหมือนกันทุกเครื่องที่ล็อกอิน · อีเมลยังใช้เข้าสู่ระบบเหมือนเดิม':
    'The name is stored with your account, so it looks the same on every device you sign in from. You still sign in with your email.',
  'ภาษา': 'Language',
  ...
  'บาท/km': 'THB/km',
  'ค่าชาร์จ': 'Charging',
  'เลขไมล์ครั้งก่อน (km)': 'Previous odometer (km)',
  'SOC ก่อน (%)': 'SOC before (%)',
  'SOC หลัง (%)': 'SOC after (%)',
  ...
  /* ระยะทางที่ "ขับมาจริง" จากเลขไมล์ ต่างจาก "ระยะทางที่วิ่งได้" ซึ่งเป็นค่าคาดการณ์ของรถ */
  'ระยะทางที่ขับมา (km)': 'Distance driven (km)',
  'คำนวณจากเลขไมล์': 'Calculated from the odometer',
  'ระยะทางที่วิ่งได้ ก่อนชาร์จ (km)': 'Range before charging (km)',
  'ระยะทางที่วิ่งได้ หลังชาร์จ (km)': 'Range after charging (km)',
  'ระยะทางที่วิ่งได้เพิ่มขึ้น (km)': 'Range gained (km)',
  'ตัวเลขที่รถหรือแอปบอกว่าวิ่งได้อีกกี่กิโลเมตร': 'What the car or app says you can still drive',
  ...
  /* ---------------- ช่องที่ต้องกรอก และข้อความบอกจุดที่ผิด ---------------- */
  'จำเป็นต้องกรอก': 'Required',
  'ช่องที่มี': 'Fields marked',
  'ต้องกรอก · ช่องอื่นเว้นว่างไว้ก่อนแล้วกลับมาเติมทีหลังได้':
    'are required — leave the rest blank now and fill them in later',
  'เลือกรถก่อนถึงจะบันทึกได้': 'Pick a car before saving',
  'ใส่วันที่ก่อนถึงจะบันทึกได้': 'Enter a date before saving',
  'ห้ามติดลบ': 'Cannot be negative',
  'ต้องมากกว่า 0': 'Must be greater than 0',
  'ต้องอยู่ระหว่าง 0 ถึง 100': 'Must be between 0 and 100',
  'วันที่ล่วงหน้าเกินวันนี้': 'Date is in the future',
  'น้อยกว่าเลขไมล์ครั้งก่อน': 'Lower than the previous odometer',
  'น้อยกว่า SOC ก่อนชาร์จ': 'Lower than the SOC before charging',
  'ส่วนลดมากกว่ายอดค่าชาร์จ': 'Discount is larger than the charge total',
  'ยังมีช่องที่ต้องแก้ ดูข้อความสีแดงใต้ช่องนั้น': 'Some fields need fixing — see the red text under them',
  'เว้นว่างไว้ก่อนได้ ชาร์จเสร็จค่อยกลับมากรอก': 'Leave blank for now and fill it in once charging is done',
  'บันทึกไว้ก่อน': 'Save for now',
  ...
  'ค่าบำรุงรักษา': 'Maintenance',
  'ค่าภาษี': 'Tax',
  'ตั้งแยกตามชนิดได้ · เว้นว่างหรือ 0 = ไม่ตั้งงบชนิดนั้น':
    'Set one per type — leave blank or 0 to skip that type',
  'ใช้จริงเฉลี่ย': 'Actual average',
  'เดือน': 'month',
  'ไม่ตั้งงบ': 'No budget',
  'งบต่อเดือนของ': 'Monthly budget for',
  'งบรวมทั้งหมด (บาท / เดือน)': 'Overall budget (฿ / month)',
  'นับค่าชาร์จและต้นทุนทุกชนิดรวมกัน รวมค่าไฟและค่าใช้จ่ายอื่นๆ ที่ไม่มีงบแยก':
    'Counts charging plus every cost type, including electricity and other costs that have no budget of their own',
  'ค่าใช้จ่ายรวมเฉลี่ยปัจจุบัน': 'Current overall average',
  'คิดจากข้อมูล {n} เดือน': 'based on {n} months of data',
  '{name} เกินงบที่ตั้งไว้': '{name} is over its budget',
  'ค่าใช้จ่ายรวมเฉลี่ยต่อเดือนเกินงบประมาณ': 'Overall monthly average is over budget',
  'ค่าใช้จ่ายรวมอยู่ในงบประมาณ': 'Overall spending is within budget',
  'มี {n} รายการที่ยังกรอกไม่ครบ': '{n} entries are still incomplete',
  'จดไว้ก่อนชาร์จแล้วยังไม่ได้เติมพลังงานที่ชาร์จได้จริง':
    'Noted before charging, but the energy actually charged has not been filled in',
  'ไปกรอกต่อ': 'Finish it',
  'ดูรายการที่ค้าง': 'See what is left',
  'มีรายการที่ยังกรอกไม่ครบ': 'Some entries are still incomplete',
  'สถานะการกรอก': 'Completeness',
  'เฉพาะที่ยังไม่ครบ': 'Incomplete only',
  'เฉพาะที่ยังไม่ครบ ({n})': 'Incomplete only ({n})',
  'รายการนี้ยังกรอกไม่ครบ': 'This entry is still incomplete',
  'ขาดพลังงานที่ชาร์จ (kWh) · กรอกแล้วกดบันทึกเพื่อให้รายการสมบูรณ์':
    'Energy charged (kWh) is missing — fill it in and save to complete the entry',
  'ยังไม่ได้กรอกพลังงานที่ชาร์จ': 'Energy charged not filled in yet',
  'บันทึกไว้ก่อนได้เลย รายการจะถูกทำเครื่องหมาย "ยังไม่ครบ" ไว้ในหน้าประวัติ ชาร์จเสร็จค่อยกดแก้ไขมาเติม':
    'Save it now — the entry is tagged "Incomplete" in History, and you can edit it to fill in the rest once charging is done',
  'บันทึกไว้แล้ว — ชาร์จเสร็จค่อยกลับมาเติมพลังงานที่ได้':
    'Saved — come back and add the energy once charging is done',
  'ข้อมูลทั้งหมด': 'All time',
  'เฉลี่ย': 'avg',
  'เฉลี่ยต่อครั้ง': 'Avg per session',
  'ราคาเฉลี่ย': 'Avg price',
  'รายการชาร์จที่นี่': 'Charges here',
  'แตะเพื่อแก้ไข': 'Tap to edit',
  'แก้ไขรายการนี้': 'Edit this charge',
  ...
  'ต้องกรอกเลขไมล์ครั้งก่อนและปัจจุบันจึงจะคำนวณได้': 'Needs the previous and current odometer to calculate',
