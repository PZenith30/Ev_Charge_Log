...
const EN = {
  ...
  /* ตัวเลขที่รถแสดงว่าวิ่งได้อีกไกลแค่ไหน — คนละอย่างกับ "ระยะทางที่วิ่งได้" ที่คำนวณจากเลขไมล์ */
  'ระยะทางก่อนชาร์จ (km)': 'Range before charging (km)',
  'ระยะทางหลังชาร์จ (km)': 'Range after charging (km)',
  'ระยะทางที่เพิ่มขึ้น (km)': 'Range gained (km)',
