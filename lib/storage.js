 ...
 *
 * ต้องไล่ให้ครบทุกที่ที่อ้างถึงรูป ไม่งั้นจะลบรูปที่ยังใช้งานอยู่ทิ้ง
 * ปัจจุบันมี 3 แหล่ง: รูปแนบของการชาร์จ · รูปแนบของต้นทุน · รูปรถ
 */
export async function gcImages(state) {
  ...
  for (const c of state.cars || []) if (c.photo) used.add(c.photo);
